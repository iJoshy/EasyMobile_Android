...
public class PrepaidEasylifeBundlesFragment extends Fragment
{
    ...
    public PrepaidEasylifeBundlesFragment()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View rootView = inflater.inflate(R.layout.fragment_prepaid_easylifebundles, container, false);
        ...
        try
        {
            ...
            LinearLayout layout = (LinearLayout) rootView.findViewById(R.id.EasyLifeLayout);
            ...
            while ( i < lengthOfBundles )
            {
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ((MainActivity) getActivity()).buyEasylifeNow(v);
                    }
                });
