...
public class PrepaidEasyflexBundlesFragment extends Fragment
{
    ...
    public PrepaidEasyflexBundlesFragment()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View rootView = inflater.inflate(R.layout.fragment_prepaid_easyflexbundles, container, false);
        ...
        try
        {
            ...
            LinearLayout layout = (LinearLayout) rootView.findViewById(R.id.EasyFlexLayout);
                ...
                if (btncount % 2 == 0)
                {
                    ...
                    btn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ((MainActivity) getActivity()).buyEasyFlexNow(v);
                        }
                    });
