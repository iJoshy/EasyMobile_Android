...
public class AirtimeTransferFragment extends Fragment
{
    private MaterialDialog dialog;

    public AirtimeTransferFragment()
    {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        View rootView = inflater.inflate(R.layout.fragment_airtime_transfer, container, false);
