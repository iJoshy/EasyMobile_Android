...
public class PrepaidEvolutionDataFragment extends Fragment
{
    ...
    public PrepaidEvolutionDataFragment()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View rootView = inflater.inflate(R.layout.fragment_prepaid_evolution_data, container, false);
        ...
        try
        {
            ...
            LinearLayout layout = (LinearLayout) rootView.findViewById(R.id.EvolutionDataLayout);
            ...
            while ( i < lengthOfBundles )
            {
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ((MainActivity) getActivity()).buyEvoultionDataNow(v);
                    }
                });
