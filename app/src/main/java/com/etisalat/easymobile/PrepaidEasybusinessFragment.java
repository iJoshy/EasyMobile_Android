...
public class PrepaidEasybusinessFragment extends Fragment
{
    ...
    public PrepaidEasybusinessFragment()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View rootView = inflater.inflate(R.layout.fragment_prepaid_easybusiness, container, false);
        ...
        try
        {
            ...
            LinearLayout layout = (LinearLayout) rootView.findViewById(R.id.EasyBizLayout);
            ...
            while ( i < lengthOfBundles )
            {
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ((MainActivity) getActivity()).buyEasybusinessNow(v);
                    }
                });
